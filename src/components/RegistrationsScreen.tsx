...
export function RegistrationsScreen({
  ...
  return (
    <div id="registrations-dashboard" className="w-full max-w-6xl mx-auto px-4 py-8 md:py-12 animate-fade-in text-left">
      ...
      <div className="flex items-center justify-between gap-4 mb-10 select-none pb-4 border-b border-slate-100">
        <div>
              ...
              return (
                <div key={reg.id} className="flex items-stretch group relative animate-fade-in">
                  ...
                  <div className="w-[80px] sm:w-[110px] pr-3 sm:pr-5 flex flex-col justify-start pt-5 text-right select-none shrink-0 font-sans">
                    <span className="font-extrabold text-[15px] sm:text-lg text-slate-800 tracking-tight leading-none group-hover:text-[#f89728] transition-colors uppercase">
                      {day} {month}
                    </span>
                    <span className="text-[10.5px] font-bold text-slate-400 font-mono tracking-wider mt-1.5 leading-none">
                      {year}
                    </span>
                  </div>
